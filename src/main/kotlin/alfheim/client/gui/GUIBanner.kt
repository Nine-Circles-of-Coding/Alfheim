...
object GUIBanner: Gui() {
	...
	val bannerHV = ResourceLocation(ModInfo.MODID, "textures/banner/HellishVacation.png")
	val bannerWOTW = ResourceLocation(ModInfo.MODID, "textures/banner/WrathOfTheWinter.png")
	...
	fun onOverlayRendering(e: RenderGameOverlayEvent.Post) {
		if (!AlfheimConfigHandler.eventBanner) return
