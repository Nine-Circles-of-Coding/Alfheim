...
class ItemSnowSword: ItemManasteelSword(snow, "SnowSword") {
	...
	override fun getIsRepairable(stack: ItemStack?, material: ItemStack) =
		material.item === AlfheimItems.elvenResource && material.meta == ElvenResourcesMetas.NiflheimPowerIngot.I
	
	override fun hitEntity(stack: ItemStack, target: EntityLivingBase, attacker: EntityLivingBase): Boolean {
		target.addPotionEffect(PotionEffect(Potion.moveSlowdown.id, 160, 1))
