...
class ModelArmorVolcano(val slot: Int): ModelBiped() {
	...
	init {
		...
		setRotateAngle(RightShoulder5, 0.0f, 0.0f, -0.17453292f)
		...
		setRotateAngle(chest8, 0.0f, 0.0f, -0.5235988f)
		...
		setRotateAngle(chest13, -0.2617994f, 0.0f, 0.0f)
		...
		setRotateAngle(mask2, 0.0f, 0.0f, -0.2617994f)
		...
		setRotateAngle(LeftShoulder5, 0.0f, 0.0f, 0.17453292f)
		...
		setRotateAngle(mask4, 0.0f, 0.0f, 0.1308997f)
		...
		setRotateAngle(chest16, -0.2617994f, 0.0f, 0.0f)
		...
		setRotateAngle(mask5, 0.0f, 0.0f, -0.1308997f)
		...
		setRotateAngle(LeftShoulder3, 0.0f, 0.0f, -0.2617994f)
		...
		setRotateAngle(RightShoulder3, 0.0f, 0.0f, 0.2617994f)
		...
		setRotateAngle(chest2, 0.0f, 0.0f, -0.08726646f)
		...
		setRotateAngle(RightShoulder2, 0.0f, 0.0f, 0.2617994f)
