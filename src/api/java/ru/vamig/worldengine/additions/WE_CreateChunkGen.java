...
public abstract class WE_CreateChunkGen {
    ...
    public void setBlock(WE_GeneratorData data, Block block, byte meta, int x_in_chunk, int y_in_chunk,
        int z_in_chunk) {
        data.chunkProvider
            .genSetBlock(data.chunkBlocks, data.chunkBlocksMeta, x_in_chunk, y_in_chunk, z_in_chunk, block, meta);
    }
